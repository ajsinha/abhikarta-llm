"""
Test Suite for Cohere LLM Facade
...
Description:
Comprehensive test suite for the Cohere LLM Facade implementation.
"""
...
from cohere_facade import CohereLLMFacade, create_cohere_llm
...
def llm():
    ...
    return CohereLLMFacade(model_name=TEST_MODEL)
...
def test_initialization():
    ...
    llm = CohereLLMFacade(model_name=TEST_MODEL)
    assert llm.model_name == TEST_MODEL
    assert llm.provider_name == "cohere"
...
def test_factory():
    ...
    llm = create_cohere_llm(TEST_MODEL)
    assert isinstance(llm, CohereLLMFacade)
    print("✓ Factory function works")


if __name__ == "__main__":
    print(f"\n============================================================")
    print(f"Cohere LLM Facade Tests")
    print(f"============================================================\n")
