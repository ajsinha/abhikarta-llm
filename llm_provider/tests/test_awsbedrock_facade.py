"""
Test Suite for Awsbedrock LLM Facade
...
Description:
Comprehensive test suite for the Awsbedrock LLM Facade implementation.
"""
...
from awsbedrock_facade import AwsbedrockLLMFacade, create_awsbedrock_llm
...
def llm():
    ...
    return AwsbedrockLLMFacade(model_name=TEST_MODEL)
...
def test_initialization():
    ...
    llm = AwsbedrockLLMFacade(model_name=TEST_MODEL)
    assert llm.model_name == TEST_MODEL
    assert llm.provider_name == "awsbedrock"
...
def test_model_info(llm):
    ...
    assert info['provider'] == "awsbedrock"
...
def test_factory():
    ...
    llm = create_awsbedrock_llm(TEST_MODEL)
    assert isinstance(llm, AwsbedrockLLMFacade)
    print("✓ Factory function works")


if __name__ == "__main__":
    print(f"\n============================================================")
    print(f"Awsbedrock LLM Facade Tests")
    print(f"============================================================\n")
