...
{content}
  ...
  <div class="fit row" style="background: #0079C1; padding: 6px 30px; justify-content: space-between; align-items: center;">
    <p style="font-size: 8px; color: #FFFFFF; margin: 0; opacity: 0.8;">Copyright © 2025-2030 Ashutosh Sinha | Patent Pending</p>
    <p style="font-size: 8px; color: #FFFFFF; margin: 0; opacity: 0.8;">{num}</p>
  </div>
</body>
</html>'''
...
all_slides.append((4, 'content', 'Key Value Propositions', '''    <div class="row gap" style="height: 100%; flex-wrap: wrap; align-content: flex-start;">
      <div style="background: #FFF; padding: 12px; border-radius: 6px; border-top: 3px solid #0079C1; width: 280px;">
      ...
      <div style="background: #FFF; padding: 12px; border-radius: 6px; border-top: 3px solid #ED1C24; width: 280px;">
...
# Section slides and content slides
sections = [
...
content_slides = [
    (6, 'Challenge: Provider Lock-In', '''    <div class="row gap" style="height: 100%;">
      <div class="col gap-sm" style="flex: 1;">
        <div style="background: #FFF; border-left: 3px solid #ED1C24; padding: 12px; border-radius: 4px;">
          ...
          <p style="font-size: 9px; color: #5A7A9C; margin: 6px 0 0 0; line-height: 1.4;">Organizations on single LLM provider face pricing changes, service disruptions, and inability to leverage competitors.</p>
        </div>
        <div style="background: #FFF; padding: 10px; border-radius: 4px;">
          <p style="font-size: 10px; color: #1A3A5C; margin: 0; font-weight: 600;">Impact</p>
          <p style="font-size: 9px; color: #5A7A9C; margin: 4px 0 0 0;">High switching costs, competitive disadvantage</p>
        </div>
      </div>
      <div class="col gap-sm" style="flex: 1;">
        <div style="background: #FFF; border-left: 3px solid #0079C1; padding: 12px; border-radius: 4px;">
          ...
          <p style="font-size: 9px; color: #5A7A9C; margin: 6px 0 0 0; line-height: 1.4;">Unified abstraction across 11+ providers. Same code, different models. Switch with config change.</p>
        </div>
        <div style="background: #FFF; padding: 10px; border-radius: 4px;">
          <p style="font-size: 10px; color: #1A3A5C; margin: 0; font-weight: 600;">Benefits</p>
          <p style="font-size: 9px; color: #5A7A9C; margin: 4px 0 0 0;">Better rates, best models, no migration</p>
        </div>
      </div>
    </div>'''),
    ...
    (7, 'Challenge: AI Governance Gaps', '''    <div class="row gap" style="height: 100%;">
      <div class="col gap-sm" style="flex: 1;">
        <div style="background: #FFF; border-left: 3px solid #ED1C24; padding: 12px; border-radius: 4px;">
          <p style="font-size: 11px; color: #ED1C24; margin: 0; font-weight: 600;">The Problem</p>
          <p style="font-size: 9px; color: #5A7A9C; margin: 6px 0 0 0; line-height: 1.4;">Shadow AI proliferates. Teams use ChatGPT without IT oversight, creating compliance and data risks.</p>
        </div>
        <div style="background: #FFF; padding: 10px; border-radius: 4px;">
          <p style="font-size: 10px; color: #1A3A5C; margin: 0; font-weight: 600;">Impact</p>
          <p style="font-size: 9px; color: #5A7A9C; margin: 4px 0 0 0;">Regulatory violations, data breaches</p>
        </div>
      </div>
      <div class="col gap-sm" style="flex: 1;">
        <div style="background: #FFF; border-left: 3px solid #0079C1; padding: 12px; border-radius: 4px;">
          <p style="font-size: 11px; color: #0079C1; margin: 0; font-weight: 600;">Our Solution</p>
          <p style="font-size: 9px; color: #5A7A9C; margin: 6px 0 0 0; line-height: 1.4;">Centralized platform with RBAC, audit logging, rate limiting. All AI through governed channels.</p>
        </div>
        <div style="background: #FFF; padding: 10px; border-radius: 4px;">
          <p style="font-size: 10px; color: #1A3A5C; margin: 0; font-weight: 600;">Benefits</p>
          <p style="font-size: 9px; color: #5A7A9C; margin: 4px 0 0 0;">Visibility, compliance, cost control</p>
        </div>
      </div>
    </div>'''),
    ...
    (8, 'Challenge: Complex Orchestration', '''    <div class="row gap" style="height: 100%;">
      <div class="col gap-sm" style="flex: 1;">
        <div style="background: #FFF; border-left: 3px solid #ED1C24; padding: 12px; border-radius: 4px;">
          <p style="font-size: 11px; color: #ED1C24; margin: 0; font-weight: 600;">The Problem</p>
          <p style="font-size: 9px; color: #5A7A9C; margin: 6px 0 0 0; line-height: 1.4;">Multi-step AI pipelines require significant engineering. Parallel execution and error handling is complex.</p>
        </div>
      </div>
      <div class="col gap-sm" style="flex: 1;">
        <div style="background: #FFF; border-left: 3px solid #0079C1; padding: 12px; border-radius: 4px;">
          <p style="font-size: 11px; color: #0079C1; margin: 0; font-weight: 600;">Our Solution</p>
          <p style="font-size: 9px; color: #5A7A9C; margin: 6px 0 0 0; line-height: 1.4;">Visual DAG workflow designer. Drag-and-drop with built-in parallel execution and retry logic.</p>
        </div>
      </div>
    </div>'''),
    ...
    (9, 'Challenge: AI Cost Management', '''    <div class="row gap" style="height: 100%;">
      <div class="col gap-sm" style="flex: 1;">
        <div style="background: #FFF; border-left: 3px solid #ED1C24; padding: 12px; border-radius: 4px;">
          <p style="font-size: 11px; color: #ED1C24; margin: 0; font-weight: 600;">The Problem</p>
          <p style="font-size: 9px; color: #5A7A9C; margin: 6px 0 0 0; line-height: 1.4;">LLM costs spiral at scale. Runaway processes generate unexpected bills.</p>
        </div>
      </div>
      <div class="col gap-sm" style="flex: 1;">
        <div style="background: #FFF; border-left: 3px solid #0079C1; padding: 12px; border-radius: 4px;">
          <p style="font-size: 11px; color: #0079C1; margin: 0; font-weight: 600;">Our Solution</p>
          <p style="font-size: 9px; color: #5A7A9C; margin: 6px 0 0 0; line-height: 1.4;">Rate limiting, token quotas. Local Ollama models at $0 cost. Usage analytics.</p>
        </div>
      </div>
    </div>'''),
]

for num, title, content in content_slides:
...
more_slides = [
    ...
    (12, 'Core Components', '''    <div class="row gap" style="height: 100%; flex-wrap: wrap; align-content: flex-start;">
      <div style="background: #FFF; border-left: 3px solid #0079C1; padding: 10px; border-radius: 4px; width: 420px;">
        <p style="font-size: 11px; color: #0079C1; margin: 0; font-weight: 600;">Agent Framework</p>
        <p style="font-size: 9px; color: #5A7A9C; margin: 4px 0 0 0;">Modular AI agents with personas, tools, memory, and knowledge bases.</p>
      </div>
      <div style="background: #FFF; border-left: 3px solid #0079C1; padding: 10px; border-radius: 4px; width: 420px;">
        <p style="font-size: 11px; color: #0079C1; margin: 0; font-weight: 600;">Workflow Engine</p>
        <p style="font-size: 9px; color: #5A7A9C; margin: 4px 0 0 0;">DAG orchestration with parallel execution and error handling.</p>
      </div>
      <div style="background: #FFF; border-left: 3px solid #ED1C24; padding: 10px; border-radius: 4px; width: 420px;">
        <p style="font-size: 11px; color: #ED1C24; margin: 0; font-weight: 600;">AI Organization Manager</p>
        <p style="font-size: 9px; color: #5A7A9C; margin: 4px 0 0 0;">Patent-pending hierarchical AI governance with HITL controls.</p>
      </div>
      <div style="background: #FFF; border-left: 3px solid #0079C1; padding: 10px; border-radius: 4px; width: 420px;">
        <p style="font-size: 11px; color: #0079C1; margin: 0; font-weight: 600;">Security Layer</p>
        <p style="font-size: 9px; color: #5A7A9C; margin: 4px 0 0 0;">RBAC, API key management, rate limiting, audit logging.</p>
      </div>
    </div>'''),
    
    (14, 'Supported LLM Providers', '''    <div class="col gap-sm" style="height: 100%;">
      <div class="row gap-sm">
        <div style="background: linear-gradient(135deg, #ED1C24, #B81419); padding: 10px; border-radius: 6px; flex: 1; text-align: center;">
          <p style="font-size: 12px; color: #FFF; margin: 0; font-weight: 600;">Ollama</p>
          <p style="font-size: 8px; color: #FFD0D0; margin: 2px 0 0 0;">DEFAULT - Free, Local</p>
        </div>
        <div style="background: #FFF; padding: 10px; border-radius: 6px; flex: 1; text-align: center;">
          ...
          <p style="font-size: 8px; color: #5A7A9C; margin: 2px 0 0 0;">GPT-4o, o1, o3</p>
        </div>
        <div style="background: #FFF; padding: 10px; border-radius: 6px; flex: 1; text-align: center;">
          <p style="font-size: 12px; color: #1A3A5C; margin: 0; font-weight: 600;">Anthropic</p>
          <p style="font-size: 8px; color: #5A7A9C; margin: 2px 0 0 0;">Claude 4.5</p>
        </div>
        <div style="background: #FFF; padding: 10px; border-radius: 6px; flex: 1; text-align: center;">
          <p style="font-size: 12px; color: #1A3A5C; margin: 0; font-weight: 600;">Google</p>
          <p style="font-size: 8px; color: #5A7A9C; margin: 2px 0 0 0;">Gemini 2.0</p>
        </div>
      </div>
      <div class="row gap-sm">
        <div style="background: #FFF; padding: 10px; border-radius: 6px; flex: 1; text-align: center;">
          <p style="font-size: 12px; color: #1A3A5C; margin: 0; font-weight: 600;">Azure OpenAI</p>
          <p style="font-size: 8px; color: #5A7A9C; margin: 2px 0 0 0;">Enterprise</p>
        </div>
        <div style="background: #FFF; padding: 10px; border-radius: 6px; flex: 1; text-align: center;">
          <p style="font-size: 12px; color: #1A3A5C; margin: 0; font-weight: 600;">AWS Bedrock</p>
          <p style="font-size: 8px; color: #5A7A9C; margin: 2px 0 0 0;">Multi-Model</p>
        </div>
        <div style="background: #FFF; padding: 10px; border-radius: 6px; flex: 1; text-align: center;">
          <p style="font-size: 12px; color: #1A3A5C; margin: 0; font-weight: 600;">Groq</p>
          <p style="font-size: 8px; color: #5A7A9C; margin: 2px 0 0 0;">Ultra-Fast</p>
        </div>
        <div style="background: #FFF; padding: 10px; border-radius: 6px; flex: 1; text-align: center;">
          <p style="font-size: 12px; color: #1A3A5C; margin: 0; font-weight: 600;">Mistral AI</p>
          <p style="font-size: 8px; color: #5A7A9C; margin: 2px 0 0 0;">EU Data</p>
        </div>
      </div>
    </div>'''),
]

for num, title, content in more_slides:
    all_slides.append((num, 'content', title, content))

# Generate remaining slides programmatically
remaining = [
    (15, 'Ollama: Default Provider', 'Why Ollama is the default: Free, local, private. 40+ models. Perfect for dev and sensitive workloads.'),
    (16, 'Provider Selection Strategy', 'Choose providers based on cost, privacy, performance, compliance, or specialized capabilities.'),
    (17, 'Unified API Benefits', 'No code changes, consistent error handling, automatic failover, standardized metrics.'),
    (19, 'Agent Architecture', 'Agents combine LLM with tools, memory, knowledge. Multi-provider support built-in.'),
    (20, 'Agent Reasoning Patterns', 'ReAct, Chain-of-Thought, Tree-of-Thoughts, Reflexion, Hierarchical, Goal-Based.'),
    (21, 'Agent Tool Integration', 'Database, API, File, Search, Custom tools. Human-in-loop for approvals.'),
    (22, 'Knowledge & RAG Pipeline', 'Ingest, Chunk, Embed, Retrieve. Supports Chroma, Pinecone, FAISS.'),
    (24, 'DAG Workflow Overview', 'Directed Acyclic Graph for complex pipelines. Parallel execution, error handling.'),
    (25, 'Workflow Node Types', 'LLM, Agent, Tool, Transform, Human, Condition nodes for any workflow.'),
    (27, 'AI Organization Overview', 'Digital twins of org structure. Tasks delegate down, responses aggregate up.'),
    (28, 'Human-in-the-Loop Controls', 'Human mirrors, approval workflows, override capability, notifications.'),
    (30, 'Security Framework', 'RBAC, audit logging, API key management, rate limiting, data isolation.'),
    (32, 'Use Case: Customer Service', 'AI chatbot with RAG. 70% resolution, 24/7 availability, consistent quality.'),
    (33, 'Use Case: Document Analysis', 'DAG workflow for contracts. 90% faster review, improved accuracy.'),
    (34, 'Use Case: Risk & Compliance', 'AI transaction monitoring, communication analysis. Audit-ready.'),
    (35, 'Use Case: Research & Reports', 'Multi-step synthesis. Hours to minutes, comprehensive coverage.'),
    (36, 'Use Case: Developer Productivity', 'AI code review, doc generation. Local models for code privacy.'),
    (38, 'Technology Stack Overview', 'Python/Flask backend, Bootstrap frontend, SQLite/PostgreSQL, Docker/K8s.'),
    (39, 'Deployment Options', 'Local dev, Docker Compose, Kubernetes, Air-gapped, Cloud, Hybrid.'),
    (40, 'Getting Started', 'pip install abhikarta-llm, abhikarta init, abhikarta web start.'),
    (41, 'Product Roadmap', 'Q1: Workflow Designer. Q2: Multi-Tenant. Q3: Industry Verticals. Q4: Marketplace.'),
    (43, 'Competitive Comparison', 'vs LangChain, AutoGen, CrewAI. Unique: Multi-provider, Visual DAG, AI Org, HITL, RBAC.'),
    (45, 'Open Source: LLM Frameworks', 'LangChain, LlamaIndex, Ollama, OpenAI SDK, Anthropic SDK, ChromaDB, FAISS.'),
    (46, 'Open Source: Web & Infra', 'Flask, SQLAlchemy, Pydantic, Bootstrap, Docker, PostgreSQL, Redis.'),
    (48, 'Open Source: Utilities', 'Click, Rich, PyYAML, Requests, NumPy, Pandas, PyPDF.'),
    (49, 'Licensing & IP', 'Proprietary license. Patent pending for AI Organization technology.'),
    (50, 'Contact & Resources', 'Documentation at /docs. Research paper in docs/research. Enterprise support available.'),
]

for num, title, desc in remaining:
    content = f'''    <div class="col gap-sm center" style="height: 100%;">
      <div style="background: #FFF; padding: 16px 24px; border-radius: 6px; max-width: 700px; text-align: center;">
...
all_slides.append((51, 'content', 'Copyright Notice', '''    <div class="col center" style="height: 100%;">
      ...
      <div style="background: #FFF; padding: 16px 24px; border-radius: 6px; margin-top: 20px; text-align: center;">
        ...
        <p style="font-size: 11px; color: #ED1C24; margin: 6px 0 0 0; font-weight: 600;">PATENT PENDING</p>
      </div>
    </div>'''))
...
for item in all_slides:
    ...
    with open(filename, 'w') as f:
        f.write(html)
    print(f"Created slide{num:02d}.html")

print(f"\nTotal slides: {len(all_slides)}")
