...
class TestAnthropicFacade(unittest.TestCase):
    """Test suite for AnthropicFacade."""
    
    def setUp(self):
        """Set up test fixtures."""
        self.api_key = "test-api-key-anthropic"
        self.model_name = "claude-3-opus-20240229"
    
    def test_initialization(self):
        """Test facade initialization."""
        facade = AnthropicFacade(
        ...
        self.assertEqual(facade.provider_name, "anthropic")
    ...
    @patch('facades.anthropic_facade.anthropic.Anthropic')
...
class TestAnthropicFacadeIntegration(unittest.TestCase):
    """Integration tests for AnthropicFacade (requires API key)."""
    ...
    @unittest.skipUnless(os.getenv("ANTHROPIC_API_KEY"), "API key not set")
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestAnthropicFacade))
    test_suite.addTest(unittest.makeSuite(TestAnthropicFacadeIntegration))
    return test_suite
