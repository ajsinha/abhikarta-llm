...
class TestMockFacade(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(facade.provider_name, "mock")
    ...
    @patch('facades.mock_facade.time.sleep')
    def test_chat_completion(self, mock_client):
        """Test chat completion."""
        # Mock the response
        mock_client.return_value = None  # Mock doesn't need external client
...
class TestMockFacadeIntegration(unittest.TestCase):
    """Integration tests for MockFacade (requires API key)."""
    ...
    @unittest.skipUnless(os.getenv("MOCK_API_KEY"), "API key not set")
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestMockFacade))
    test_suite.addTest(unittest.makeSuite(TestMockFacadeIntegration))
    return test_suite
