...
class TestOpenAIFacade(unittest.TestCase):
    """Test suite for OpenAIFacade."""
    
    def setUp(self):
        """Set up test fixtures."""
        self.api_key = "test-api-key-openai"
    ...
    def test_initialization(self):
        ...
        self.assertEqual(facade.provider_name, "openai")
    ...
    @patch('facades.openai_facade.OpenAI')
...
class TestOpenAIFacadeIntegration(unittest.TestCase):
    """Integration tests for OpenAIFacade (requires API key)."""
    ...
    @unittest.skipUnless(os.getenv("OPENAI_API_KEY"), "API key not set")
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestOpenAIFacade))
    test_suite.addTest(unittest.makeSuite(TestOpenAIFacadeIntegration))
    return test_suite
