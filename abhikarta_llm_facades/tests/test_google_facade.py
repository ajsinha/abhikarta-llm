...
class TestGoogleFacade(unittest.TestCase):
    """Test suite for GoogleFacade."""
    
    def setUp(self):
        """Set up test fixtures."""
        self.api_key = "test-api-key-google"
    ...
    def test_initialization(self):
        ...
        self.assertEqual(facade.provider_name, "google")
    ...
    @patch('facades.google_facade.genai')
...
class TestGoogleFacadeIntegration(unittest.TestCase):
    """Integration tests for GoogleFacade (requires API key)."""
    ...
    @unittest.skipUnless(os.getenv("GOOGLE_API_KEY"), "API key not set")
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestGoogleFacade))
    test_suite.addTest(unittest.makeSuite(TestGoogleFacadeIntegration))
    return test_suite
