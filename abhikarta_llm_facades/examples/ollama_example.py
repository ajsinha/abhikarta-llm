"""
Ollama Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the Ollama provider.
"""
...
def example_context_manager():
    ...
    with OllamaFacade(model_name="llama2") as llm:
        messages = [
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"Ollama Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
