"""
HuggingFace Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the HuggingFace provider.
"""
...
def example_context_manager():
    ...
    with HuggingfaceFacade(model_name="meta-llama/Llama-2-7b-chat-hf") as llm:
        messages = [
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"HuggingFace Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
    
    # Check for API key
    if not os.getenv("HF_TOKEN"):
        print(f"Warning: HF_TOKEN environment variable not set")
