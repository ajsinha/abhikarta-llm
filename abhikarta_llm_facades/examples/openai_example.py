"""
OpenAI Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the OpenAI provider.
"""
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"OpenAI Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
    
    # Check for API key
    if not os.getenv("OPENAI_API_KEY"):
        print(f"Warning: OPENAI_API_KEY environment variable not set")
