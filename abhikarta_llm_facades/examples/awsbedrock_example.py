"""
AWS Bedrock Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the AWS Bedrock provider.
"""
...
def example_context_manager():
    ...
    with AWSBedrockFacade(model_name="anthropic.claude-3-sonnet") as llm:
        messages = [
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"AWS Bedrock Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
