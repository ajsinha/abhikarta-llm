"""
Mistral Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the Mistral provider.
"""
...
def example_context_manager():
    ...
    with MistralFacade(model_name="mistral-large-latest") as llm:
        messages = [
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"Mistral Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
    
    # Check for API key
    if not os.getenv("MISTRAL_API_KEY"):
        print(f"Warning: MISTRAL_API_KEY environment variable not set")
