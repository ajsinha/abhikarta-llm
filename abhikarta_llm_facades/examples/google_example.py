"""
Google Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the Google provider.
"""
...
def example_context_manager():
    ...
    with GoogleFacade(model_name="gemini-pro") as llm:
        messages = [
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"Google Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
    
    # Check for API key
    if not os.getenv("GOOGLE_API_KEY"):
        print(f"Warning: GOOGLE_API_KEY environment variable not set")
