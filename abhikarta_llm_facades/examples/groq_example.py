"""
Groq Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the Groq provider.
"""
...
def example_context_manager():
    ...
    with GroqFacade(model_name="llama2-70b-4096") as llm:
        messages = [
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"Groq Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
    
    # Check for API key
    if not os.getenv("GROQ_API_KEY"):
        print(f"Warning: GROQ_API_KEY environment variable not set")
