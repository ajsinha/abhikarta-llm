"""
Anthropic Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the Anthropic provider.
"""
...
def example_context_manager():
    ...
    with AnthropicFacade(model_name="claude-3-opus-20240229") as llm:
        messages = [
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"Anthropic Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
    
    # Check for API key
    if not os.getenv("ANTHROPIC_API_KEY"):
        print(f"Warning: ANTHROPIC_API_KEY environment variable not set")
