"""
Replicate Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the Replicate provider.
"""
...
def example_context_manager():
    ...
    with ReplicateFacade(model_name="meta/llama-2-70b-chat") as llm:
        messages = [
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"Replicate Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
    
    # Check for API key
    if not os.getenv("REPLICATE_API_TOKEN"):
        print(f"Warning: REPLICATE_API_TOKEN environment variable not set")
