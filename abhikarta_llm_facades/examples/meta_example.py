"""
Meta Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the Meta provider.
"""
...
def example_context_manager():
    ...
    with MetaFacade(model_name="llama-3.1-70b-instruct") as llm:
        messages = [
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"Meta Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
