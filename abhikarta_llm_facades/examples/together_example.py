"""
Together Provider Example - Abhikarta LLM Facades
...
Description:
Complete executable example demonstrating all features of the Together provider.
"""
...
def example_context_manager():
    ...
    with TogetherFacade(model_name="mistralai/Mixtral-8x7B-Instruct-v0.1") as llm:
        messages = [
...
def main():
    """Run all examples."""
    print(f"\n{'='*60}")
    print(f"Together Provider Examples - Abhikarta LLM Facades")
    print(f"{'='*60}\n")
    
    # Check for API key
    if not os.getenv("TOGETHER_API_KEY"):
        print(f"Warning: TOGETHER_API_KEY environment variable not set")
