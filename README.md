...
## 🎨 NEW in v3.1.5: Multimodal & Document Support
...
```bash
# Extract package
tar -xzf abhikarta-llm-v3.1.5-FINAL.tar.gz
cd abhikarta-llm
...
### Multimodal Features (NEW v3.1.5)
...
<!--
Copyright 2025-2030 all rights reserved
Ashutosh Sinha | ajsinha@gmail.com | Version: 3.1.5
-->
