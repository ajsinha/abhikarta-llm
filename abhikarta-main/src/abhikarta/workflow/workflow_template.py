...
class WorkflowTemplateManager:
                ...
                dag_definition={
                    "nodes": [
                        ...
                        {"node_id": "process", "node_type": "llm", "name": "LLM Process",
                         ...
                         "config": {"provider": "ollama", "model": "llama3.2:3b", "base_url": "http://192.168.2.36:11434", "system_prompt": "Process the input data and generate output."}},
                ...
                dag_definition={
                    "nodes": [
                        ...
                        {"node_id": "branch1", "node_type": "llm", "name": "Process Branch A",
                         ...
                         "config": {"provider": "ollama", "model": "llama3.2:3b", "base_url": "http://192.168.2.36:11434", "system_prompt": "Process this item with approach A."}},
                        {"node_id": "branch2", "node_type": "llm", "name": "Process Branch B",
                         "position": {"x": 550, "y": 250},
                         "config": {"provider": "ollama", "model": "llama3.2:3b", "base_url": "http://192.168.2.36:11434", "system_prompt": "Process this item with approach B."}},
                        ...
                        {"node_id": "aggregate", "node_type": "llm", "name": "Aggregate Results",
                         ...
                         "config": {"provider": "ollama", "model": "llama3.2:3b", "base_url": "http://192.168.2.36:11434", "system_prompt": "Combine all branch results into a unified response."}},
                ...
                dag_definition={
                    "nodes": [
                        ...
                        {"node_id": "large_handler", "node_type": "llm", "name": "Large Data Handler",
                         ...
                         "config": {"provider": "ollama", "model": "llama3.2:3b", "base_url": "http://192.168.2.36:11434", "system_prompt": "Handle large data with chunking strategy."}},
                        ...
                        {"node_id": "medium_handler", "node_type": "llm", "name": "Medium Data Handler",
                         ...
                         "config": {"provider": "ollama", "model": "llama3.2:3b", "base_url": "http://192.168.2.36:11434", "system_prompt": "Handle medium-sized data normally."}},
                        {"node_id": "small_handler", "node_type": "llm", "name": "Small Data Handler",
                         "position": {"x": 900, "y": 500},
                         "config": {"provider": "ollama", "model": "llama3.2:3b", "base_url": "http://192.168.2.36:11434", "system_prompt": "Handle small data with quick processing."}},
                ...
                dag_definition={
                    "nodes": [
                        ...
                        {"node_id": "draft", "node_type": "llm", "name": "Generate Draft",
                         "position": {"x": 300, "y": 200},
                         "config": {"provider": "ollama", "model": "llama3.2:3b", "base_url": "http://192.168.2.36:11434", "system_prompt": "Generate a draft based on the request."}},
                        ...
                        {"node_id": "revise", "node_type": "llm", "name": "Revise Draft",
                         "position": {"x": 700, "y": 200},
                         "config": {"provider": "ollama", "model": "llama3.2:3b", "base_url": "http://192.168.2.36:11434", "system_prompt": "Incorporate feedback and improve the draft."}},
                ...
                dag_definition={
                    "nodes": [
                        ...
                        {"node_id": "analyze", "node_type": "llm", "name": "Analyze Combined",
                         "position": {"x": 900, "y": 200},
                         "config": {"provider": "ollama", "model": "llama3.2:3b", "base_url": "http://192.168.2.36:11434", "system_prompt": "Analyze the combined data and provide insights."}},
    ...
    def _load_json_templates(self):
        ...
        # Path: workflow_template.py -> workflow -> abhikarta -> src -> abhikarta-main/entity_definitions
        ...
        templates_dir = os.path.join(main_dir, 'entity_definitions', 'workflows')
